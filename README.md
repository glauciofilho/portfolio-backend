...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | `/contact/form/` | Create new message |

### Analytics

| Method | Endpoint | Description |
|--------|----------|-------------|
| GET | `/analytics/overview/` | Get GA overview data |
| GET | `/analytics/countries/` | Get GA countries data |
| GET | `/analytics/projects/` | Get GA projects data |
